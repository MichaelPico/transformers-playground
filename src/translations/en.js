export default {
  ...
  'dashboard.description': 'Explore the power of ML models with our interactive tools.',
  
  // Common
  'app.title': 'Transformers Playground',

  // NER Page
  'ner.inputTextLabel': 'Input Text',
  'ner.extractTokensButton': 'Extract Tokens',
  'ner.extractedTokensTitle': 'Extracted Tokens',
  'ner.tokenType.PER': 'Person',
  'ner.tokenType.ORG': 'Organization',
